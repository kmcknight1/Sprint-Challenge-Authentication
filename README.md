...
It allows you to select the amount of times the password is hashed, each hash making it many times more difficult to hack.

1. What are the three parts of the JSON Web Token?

Payload (body/data), secret, options.
